...
int nexmon_bcmsdh_probe(struct device *dev);
int nexmon_bcmsdh_remove(struct device *dev);

EXPORT_SYMBOL(nexmon_bcmsdh_probe);
EXPORT_SYMBOL(nexmon_bcmsdh_remove);

#else
/* forward declarations */
static int __devinit nexmon_bcmsdh_probe(struct device *dev);
static int __devexit nexmon_bcmsdh_remove(struct device *dev);
#endif
