...
{
#ifdef CONFIG_NEXDHD_FW_PATH
	bcm_strncpy_s(fw_path, sizeof(fw_path), CONFIG_NEXDHD_FW_PATH, MOD_PARAM_PATHLEN-1);
#else /* CONFIG_NEXDHD_FW_PATH */
	fw_path[0] = '\0';
#endif /* CONFIG_NEXDHD_FW_PATH */
#ifdef CONFIG_NEXDHD_NVRAM_PATH
	bcm_strncpy_s(nv_path, sizeof(nv_path), CONFIG_NEXDHD_NVRAM_PATH, MOD_PARAM_PATHLEN-1);
#else /* CONFIG_NEXDHD_NVRAM_PATH */
	nv_path[0] = '\0';
#endif /* CONFIG_NEXDHD_NVRAM_PATH */
#ifdef SOFTAP
	fw_path2[0] = '\0';
#endif
}
