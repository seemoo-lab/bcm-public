...
#ifndef CONFIG_NEXMON_DHD_USE_STATIC_BUF
#error STATIC_WL_PRIV_STRUCT should be used with CONFIG_NEXMON_DHD_USE_STATIC_BUF
#endif /* CONFIG_NEXMON_DHD_USE_STATIC_BUF */
	u8 *escan_buf;
#else
